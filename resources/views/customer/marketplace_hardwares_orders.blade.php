...
@section('content')
  ...
  <div class="container">
    ...
    <tbody>
      ...
      <!-- <td>21000</td>  -->
      <td><a href="{{ url('/customer/session/marketplace/hardwares-order-details/' . $oh->ordplcd_order_no) }}"
      class="btn btn-sm btn-outline-primary" title="View H/W Details">View</a></td>
      </tr>
    @endforeach
    @else
      <tr>
