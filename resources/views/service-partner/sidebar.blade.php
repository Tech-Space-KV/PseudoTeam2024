    ...
    <div class="container text-light">
        ...
        <div class="row justify-content-md-center">
            <div class="col col-lg-10 sitem  d-flex flex-column align-items-center mx-2 text-decoration-none">
                <a href="{{ url('/service-partner/session/') }}" class="text-decoration-none"><i
        ...
        <div class="row justify-content-md-center">
            <div class="col col-lg-5 sitem  d-flex flex-column align-items-center mx-2 text-decoration-none">
                <a href="{{ url('service-partner/session/manage_project') }}" class="text-decoration-none"> <i
                        class="fa fa-upload card cardbg p-3 iconix"></i>
                </a> <span class="fst">Manage Project</span>
            </div>
            <div class="col col-lg-5 sitem  d-flex flex-column align-items-center mx-2 text-decoration-none">
                <a href="{{ url('service-partner/session/all-projects') }}" class="text-decoration-none"> <i
        ...
        <div class="row justify-content-md-center">
            <div class="col col-lg-5 sitem  d-flex flex-column align-items-center mx-2 text-decoration-none">
                <a href="{{ url('service-partner/session/reports') }}" class="text-decoration-none"> <i
                        class="fa fa-object-group card cardbg p-3 iconix"></i>
                </a> <span class="fst">Reports</span>
            </div>
            <div class="col col-lg-5 sitem  d-flex flex-column align-items-center mx-2 text-decoration-none">
                <a href="{{ url('service-partner/session/hardware') }}" class="text-decoration-none"> <i
        ...
        <div class="row justify-content-md-center">
            <div class="col col-lg-5 sitem  d-flex flex-column align-items-center mx-2 text-decoration-none">
                <a href="{{ url('service-partner/session/help') }}" class="text-decoration-none"> <i
                        class="fa fa-phone-square card cardbg p-3 iconix"></i>
                </a> <span class="fst">Help</span>
            </div>
            <div class="col col-lg-5 sitem  d-flex flex-column align-items-center mx-2 text-decoration-none">
                <a href="{{ url('service-partner/session/profileoptions') }}" class="text-decoration-none"> <i
