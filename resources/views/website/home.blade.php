...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/web/website_home_mobile.css') }}">
...
<body class="bg-dark" onload="typeWriter()">
    ...
    <div class="bg-gif section-animate h-shifter" id="section-animate1">
          ...
          <div class="collapse navbar-collapse" id="">
            ...
            <div class="p-5 bg-body-tertiary">
                <div class="container-fluid py-5">
                    <br>
                    <h3 class="fw-bold text-light display-1 neon-yellow-border-text f-shifter-head"><span
    ...
    <div class="bg-light section-animate" id="section-animate1">
      ...
      <div class="container-fluid">
        ...
        <div class="px-2">
            ...
            <div class="p-5 bg-body-tertiary">
                <div class="container-fluid py-5">
                    <p class="display-3 text-center text-secondary">Offering a diverse range of IT services, tailored to
                        meet the needs of various industries</p>
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 mt-4 div-hide">
                        <!-- Card 1 -->
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Streamline your operations with DevOps practices and automation
                                        tools that improve development speed and reliability.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Card 2 -->
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Unlock the potential of AI and ML to automate tasks, predict
                                        trends, and enhance customer experiences for your business.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Card 3 -->
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Our experts provide strategic guidance to align your technology
                                        with business objectives, driving digital success.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Card 4 -->
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">We design, implement, and manage secure network infrastructures
                                        to keep your business connected and efficient.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Card 5 -->
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Optimize your business processes with our digital
                                        transformation strategies, tailored to drive innovation and growth.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Card 6 -->
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">We develop custom software solutions that address specific
                                        business needs, enhancing efficiency and productivity.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Card 7 -->
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Leverage data insights to make informed business decisions. We
                                        provide end-to-end analytics solutions tailored to your needs.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Card 8 -->
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">We offer scalable cloud solutions that enhance accessibility,
                                        security, and data management for your business.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mx-auto mt-4">
                        <a href="{{ url('services') }}" class="btn btn-sm  btn-outline-primary btn-lg mt-2 mx-auto"
                            style="width: 260px" type="button">View All <i class="material-icons"
                                style="font-size:14px">arrow_forward</i></a>
                        </button>
                    </div>
                        ...
                        <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
                            ...
                            <div class="col">
                                <div class="row row-cols-1 row-cols-sm-2 g-4">
                                    <div class="col d-flex flex-column gap-2 m-2"
                                        style="width:280px; background-color:#f24f1c; ">
                                        <div
                                            class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
                                        </div>
                                        <h5 class="fw-bold mb-0 text-light"><i
                                                class="material-icons">supervisor_account</i> Dedicated Intermediaries
                                        </h5>
                                        <p class="text-light">We act as dedicated intermediaries, ensuring that every
                                            project is meticulously managed and delivered to perfection.</p>
                                    </div>

                                    <div class="col d-flex flex-column gap-2 m-2"
                                        style="width:280px; background-color:#80bb00;">
                                        <div
                                            class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
                                        </div>
                                        <h5 class="fw-bold mb-0 text-light"><i class="material-icons">view_module</i>
                                            Structured Process</h5>
                                        <p class="text-light">We offer a structured and reliable process, overcoming
                                            common freelancing issues like communication breakdowns, inconsistent
                                            quality, and missed deadlines.</p>
                                    </div>

                                    <div class="col d-flex flex-column gap-2 m-2"
                                        style="width:280px; background-color:#00a5ef;">
                                        <div
                                            class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
                                        </div>
                                        <h5 class="fw-bold mb-0 text-light"><i
                                                class="material-icons">perm_data_setting</i> Comprehensive Services
                                        </h5>
                                        <p class="text-light">Our services include detailed project scoping, regular
                                            progress updates, quality assurance, and timely delivery to ensure project
                                            success.</p>
                                    </div>

                                    <div class="col d-flex flex-column gap-2  m-2"
                                        style="width:280px; background-color:#ffba00;">
                                        <div
                                            class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
                                        </div>
                                        <h5 class="fw-bold mb-0 text-light"><i class="material-icons">star</i>
                                            Commitment to Excellence</h5>
                                        <p class="text-light">PseudoTeam’s commitment to excellence and customer
                                            satisfaction makes us the ideal choice for a hassle-free and professional
                    ...
                    <div class="row align-items-md-stretch">
                        <div class="col-md-6 mt-1">
                            <div class="h-100 p-5 text-dark bg-light">
                                ...
                                <p>Elevate your project experience with PseudoTeam. We ensure flawless execution and
                                    timely delivery, eliminating common freelancing pitfalls. Trust us to handle your
                                    project with precision and professionalism.</p>
                                <a href="{{ url('authentication/customer/sign-in') }}" class="btn btn-outline-dark"
                                    type="button">Get Onboard <i class="material-icons"
                        ...
                        <div class="col-md-6 mt-1">
                            <div class="h-100 p-5 text-light bg-secondary">
                                ...
                                <p>Boost your freelancing career with Pseudoteam. Focus on what you do best while we
                                    handle client interactions and project management. Join us to work efficiently and
                                    get paid promptly!</p>
                                <a class="btn btn-outline-light" type="button"
                                    href="{{ url('/authentication/service-partner/sign-in') }}">Find Work <i
                                        class="material-icons" style="font-size:14px">work</i></a>
                            </div>
                        </div>
                    </div>
                    </br></br>
                ...
                <form class="needs-validation p-3" action="submit-query" method="POST" novalidate>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea type="text" class="form-control" name="query" id="address"
                                placeholder="Please write your query here." rows="6" required></textarea>
                        </div>

                        <div class="col-12">
                            <label for="address2" class="form-label">Contact no.</label>
                            <input type="tel" class="form-control" name="contact" id="address2"
