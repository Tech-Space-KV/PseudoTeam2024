        ...
        <div class="card-body">
          <fieldset class="active">
            <div class="form-group">
              <label>Country</label>
              <select class="form-control form-select" id="country" name="country" onchange="populateCities();" required>
            ...
            <div class="form-group">
              <label>Pincode</label>
              <input class="form-control" id="pincode" name="pincode" type="text" placeholder="Area Pincode" required>
            </div>
            <div class="form-group">
      ...
      <div class="card" id="card-two" style="display: none;">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="about" name="about" required autocomplete="off" placeholder="Please describe your work" rows="3"></textarea>
          </div>
  ...
  <script>
    ...
    function submitForm(event) {
      ...
      if (isFormValid) {
        ...
        window.location.href = "http://127.0.0.1:8000/customer/session/";
      } else {
    ...
    document.addEventListener("click", function(event) {
      if (!event.target.closest("#orgSuggestions") && !event.target.closest("#orgName")) {
        document.getElementById("orgSuggestions").style.display = "none";
      }
    });
  </script>
