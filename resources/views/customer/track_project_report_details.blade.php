...
@section('content')
  ...
  <div class="container">
    ...
    <h5 style="font-weight: bold;" class="text-pseudo">Progress till now:</h5>
    ...
    <div class="progress-bar" role="progressbar" style="width: {{ $average }}%;" aria-valuenow="25" aria-valuemin="0"
      aria-valuemax="100">{{ $average }}% completed</div>
    </div>
