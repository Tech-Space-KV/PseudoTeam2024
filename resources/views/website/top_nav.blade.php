<nav class="navbar navbar-expand-lg navhide"
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
          ...
          <li class="nav-item">
            <form class="d-flex nav-link nav-text" role="search">
              <div class="input-group">
                <input type="text" class="form-control form-control-sm" placeholder="Search a service here"
                  aria-label="Search a service here" aria-describedby="button-addon2">
      ...
      <span class="navbar-text">
        <a class="nav-link nav-text px-4 glow-text" href="{{ route('ask_for_quote') }}" {{--data-bs-toggle="modal"
          data-bs-target="#exampleModal" --}}>Get Critical Spares & IT Services</a>
      </span>
      <span class="navbar-text">
    ...
    if (window.location.hostname === "https://pseudoteam.com/PseudoTeam2024/public/ask/for/quote") {
      ...
      menuItems.forEach(function (item) {
        item.addEventListener("click", function () {
          window.location.href = "https://pseudoteam.com/PseudoTeam2024/public/";
        });
      });
    }
  };
