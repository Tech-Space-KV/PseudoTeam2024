...
<!--demo push-->
  <div class="container w-100 mb-4">
    <form action="{{ route('hardware.store') }}" method="POST" id="hardware-form" style="background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
      @csrf
      <!-- Serial Number -->
      <div class="form-group">
        <label for="serialNumber" class="form-label">Serial Number <span class="text-muted">(optional)</span></label>
        <input type="text" id="serialNumber" class="form-control" name="hrdws_serial_number" placeholder="Serial number of h/w">
      </div>
      <br>
      <!-- Hardware Identifier -->
      <div class="form-group">
        <label for="hardwareIdentifier" class="form-label">Hardware Identifier</label>
        <input type="text" id="hardwareIdentifier" name="hrdws_hw_identifier" class="form-control" placeholder="Identifier">
      </div>
      <br>
      <!-- Model Number -->
      <div class="form-group">
        <label for="modelNumber" class="form-label">Model Number</label>
        <input type="text" id="modelNumber" name="hrdws_model_number" class="form-control" placeholder="H/w model number">
      </div>
      <br>
      <!-- Model Description -->
      <div class="form-group">
        <label for="modelDescription" class="form-label">Model Description</label>
        <textarea id="modelDescription" name="hrdws_model_description" class="form-control" placeholder="Description and details"></textarea>
      </div>
      <br>
      <!-- Quantity -->
      <div class="form-group">
        <label for="quantity" class="form-label">Quantity</label>
        <input type="number" id="quantity" name="hrdws_qty" required class="form-control" placeholder="Quantity" min="1">
      </div>
      <br>
      <!-- Family -->
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" id="state" name="hrdws_state" class="form-control" placeholder="State where H/w is available">
      </div>
      <br>
      <!-- Price Per Unit -->
      <div class="form-group">
