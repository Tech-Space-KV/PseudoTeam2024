    ...
    <form action="/project/store" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <div class="d-flex">
                ...
                <div style="width: 465px;">
                    <input type="number" class="form-control" id="budgetAmount" name="plist_budget" placeholder="Enter amount" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="date" class="form-control" id="startDate" name="plist_startdate" placeholder="Start date" required>
            </div>

            <div class="col-md-6 mb-3">
                <label for="endDate" class="form-label">End date</label>
                <input type="date" class="form-control" id="endDate" name="plist_enddate" placeholder="End date" required>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" name="plist_name" placeholder="Name of the authorised person" required>
        </div>

        <div class="mb-3">
            <label for="email" class="form-label">Email</label>
            <input type="email" class="form-control" id="title" name="plist_email" placeholder="Email of the authorised person" required>
        </div>

        <div class="mb-3">
            <label for="contact" class="form-label">Contact</label>
            <input type="text" class="form-control" id="title" name="plist_contact" placeholder="Contact no. of authorised person" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" id="emailInput" name="plist_additional_email" placeholder="Additional email" readonly>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" name="plist_coupon" placeholder="Add your coupon or promocode here">
        </div>
