        ...
        <div class="card-body">
          <fieldset class="active">
            <div class="form-group">
              <label>Country</label>
              <select class="form-control form-select" id="country" name="pown_country" onchange="populateCities();"
                required>
            ...
            <div class="form-group">
              <label>Pincode</label>
              <input class="form-control" id="pincode" type="text" name="pown_pincode" placeholder="Area Pincode"
                required>
            </div>
            <div class="form-group">
              <label>Mailing Address</label>
              <textarea class="form-control" id="address" rows="3" placeholder="Your address" name="pown_address"
                required></textarea>
            </div>
      ...
      <div class="card" id="card-two" style="display: none;">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="about" required autocomplete="off" name="pown_about"
              placeholder="Please describe about your work" name="pown_about" rows="3"></textarea>
          </div>
          <div id="organizationFields">
            <div class="form-group">
              <label for="cin">CIN</label>
              <input class="form-control" id="cin" name="pown_cin" type="text" placeholder="Enter CIN">
            </div>
            <div class="form-group">
              <label for="gst">GST Number</label>
              <input class="form-control" id="gst" name="pown_gstpin" type="text" placeholder="Enter GST Number">
            </div>
          </div>
          <div id="individualFields" style="display: none;">
            <div class="form-group">
              <label>Any Government ID</label>
              <input class="form-control" id="govtID" type="file" name="pown_govt_id" accept="image/*">
            </div>
          </div>
          <div class="btn-group">
